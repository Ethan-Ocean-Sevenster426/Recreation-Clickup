...
ALLOWED_HOSTS = [h.strip() for h in os.getenv('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,0.0.0.0,167.88.43.168,77.37.121.135,eclick.co.za,www.eclick.co.za').split(',') if h.strip()]
